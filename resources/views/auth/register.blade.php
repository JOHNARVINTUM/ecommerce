            ...
            <div class="grid w-full overflow-hidden rounded-[2rem] border border-white/10 bg-[#12141c]/90 shadow-[0_40px_90px_rgba(0,0,0,0.45)] md:grid-cols-[1.05fr_0.95fr]">
                <div class="relative hidden md:block">
                    ...
                    <div class="absolute inset-x-8 bottom-8">
                        <p class="text-xs font-semibold uppercase tracking-[0.28em] text-white/70">Create your account</p>
                        <p class="mt-3 text-3xl font-black leading-tight text-white">Start building with<br>LIMAX today</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col justify-center p-6 sm:p-10 md:px-12 md:py-14">
                    ...
                    <h1 class="text-4xl font-black leading-tight text-white sm:text-5xl">Create your account</h1>
                    <p class="mt-2 text-base text-white/60 sm:text-lg">
                        Have an account?
                        <a href="{{ route('login') }}" class="underline underline-offset-4 hover:text-white">Log in here</a>
                    </p>
